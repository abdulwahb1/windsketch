...
const Book = () => {
  return (
    <section className="flex flex-col justify-center items-center mt-[400px] relative">
      <div
      ...
      <div className="flex flex-col justify-between items-center w-[1396px] h-[791px] bg-white rounded-xl mt-[60px] z-20"></div>
      <div className="flex flex-row  z-20  mt-10">
